...
ActiveRecord::Schema.define(version: 2019_05_30_201222) do
  ...
  create_table "spree_braintree_checkouts", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
